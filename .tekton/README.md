...
To modify the pipelines for `odh-model-controller` in the `rhoai-3.6-ea.1` release:
...
```bash
git commit -am "Update pipelinerun for odh-model-controller (rhoai-3.6-ea.1)"
